...
- **Go Documentation:** When seeking documentation for Go packages or symbols, ALWAYS prefer using the `godoc` tool. Only use `WebFetch` or `GoogleSearch` if `godoc` does not provide a clear answer.
